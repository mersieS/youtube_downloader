class Ytmp3 < Formula
  ...
  homepage "https://github.com/sbuker/youtube_downloader"
  version "0.1.0"
  license "MIT"

  on_macos do
    on_arm do
      url "https://github.com/sbuker/youtube_downloader/releases/download/v#{version}/ytmp3-darwin-arm64.tar.gz"
    ...
    on_intel do
      url "https://github.com/sbuker/youtube_downloader/releases/download/v#{version}/ytmp3-darwin-amd64.tar.gz"
